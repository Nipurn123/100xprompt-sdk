...
export class Plugin extends HeyApiClient {
     ...
     */
    marketplaces(parameters, options) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }] }]);
        return (options?.client ?? this.client).get({
    ...
    install(parameters, options) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }, { in: 'body', key: 'source' }] }]);
        return (options?.client ?? this.client).post({
            url: '/plugin/install',
            ...options,
            ...params,
     ...
     */
    installNamed(parameters, options) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }, { in: 'body', key: 'name' }] }]);
        return (options?.client ?? this.client).post({
     ...
     */
    marketplaceAdd(parameters, options) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }, { in: 'body', key: 'source' }] }]);
        return (options?.client ?? this.client).post({
     ...
     */
    marketplaceRemove(parameters, options) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }, { in: 'body', key: 'source' }] }]);
        return (options?.client ?? this.client).post({
...
export class RemoteBridge extends HeyApiClient {
    ...
    revoke(parameters, options) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'deviceID' }, { in: 'query', key: 'directory' }] }]);
        return (options?.client ?? this.client).post({
