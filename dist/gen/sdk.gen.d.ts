...
export declare class Plugin extends HeyApiClient {
    /**
     * List installed plugins
     */
    installed<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginInstalledResponses, unknown, ThrowOnError, "fields">;
    /**
     * Browse plugins across added marketplaces
     */
    discover<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginDiscoverResponses, unknown, ThrowOnError, "fields">;
    /**
     * List added marketplace sources
     */
    marketplaces<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginMarketplacesResponses, unknown, ThrowOnError, "fields">;
    /**
     * List plugins that failed to load
     */
    errors<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginErrorsResponses, unknown, ThrowOnError, "fields">;
    /**
     * Activate pending plugin changes in the current session
     */
    reload<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginReloadResponses, unknown, ThrowOnError, "fields">;
    /**
    ...
    install<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        source?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginInstallResponses, PluginInstallErrors, ThrowOnError, "fields">;
    /**
     * Install a plugin by name from added marketplaces
     */
    installNamed<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        name?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginInstallNamedResponses, PluginInstallNamedErrors, ThrowOnError, "fields">;
    /**
    ...
    setEnabled<ThrowOnError extends boolean = false>(parameters?: {
        ...
        name?: string;
        enabled?: boolean;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginSetEnabledResponses, unknown, ThrowOnError, "fields">;
    /**
     * Uninstall a plugin
     */
    remove<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        name?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginRemoveResponses, unknown, ThrowOnError, "fields">;
    /**
     * Add a marketplace source
     */
    marketplaceAdd<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        source?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginMarketplaceAddResponses, unknown, ThrowOnError, "fields">;
    /**
     * Remove a marketplace source
     */
    marketplaceRemove<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        source?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<PluginMarketplaceRemoveResponses, unknown, ThrowOnError, "fields">;
}
export declare class Trust extends HeyApiClient {
    /**
     * Get workspace trust status for the current directory
     */
    status<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<TrustStatusResponses, unknown, ThrowOnError, "fields">;
    /**
     * Trust the current directory for this session only
     */
    once<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<TrustOnceResponses, unknown, ThrowOnError, "fields">;
    /**
     * Trust the current directory and persist it across sessions
     */
    always<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<TrustAlwaysResponses, unknown, ThrowOnError, "fields">;
}
export declare class RemoteBridge extends HeyApiClient {
    /**
     * Enrol a device and mint a bridge token
     *
     * Registers the calling device in the bridge trust store and returns a short-lived signed token for the WebSocket endpoint.
     */
    enroll<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        device?: {
            id?: string;
            name?: string;
        ...
        sessionID?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<RemoteBridgeEnrollResponses, unknown, ThrowOnError, "fields">;
    /**
     * List bridge devices
     */
    devices<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<RemoteBridgeDevicesResponses, unknown, ThrowOnError, "fields">;
    /**
     * Revoke a bridge device
     *
     * Permanently refuses the device. Takes effect on the next connection attempt even if its token is still unexpired, and kicks any connection it currently holds.
     */
    revoke<ThrowOnError extends boolean = false>(parameters: {
        deviceID: string;
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<RemoteBridgeRevokeResponses, unknown, ThrowOnError, "fields">;
    /**
     * Attach to a session over the bridge WebSocket
     */
    connect<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<RemoteBridgeConnectResponses, unknown, ThrowOnError, "fields">;
}
...
export declare class Revert extends HeyApiClient {
     ...
     * Preview revert
     *
     * Dry-run a revert: which files would change with +/- line counts, and whether it would overwrite content modified outside the session.
     */
...
export declare class Session extends HeyApiClient {
    ...
    /**
     * Rate the last Auto-routed turn
     *
     * Send explicit 👍/👎 feedback for the most recent turn that the 'Auto' model router steered. Attributed to that turn's routing decision and forwarded to the routing proxy. A no-op (matched:false) when the last turn was not proxy-routed.
     */
